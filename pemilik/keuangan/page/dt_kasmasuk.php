...
<div class="content-wrapper">
        ...
        <h1> Data Kas Masuk </h1>
            ...
            <li class="active"><a href="?pg=pggna&act=view">Data Transaksi Masuk</a></li>
             </ol>
        </section>
...
<div class="content-wrapper">
        ...
        <h1> Data Kas Masuk </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=masuk&act=view">Data Transaksi Masuk</a></li>
            <li class="active"><a href="#">Tambah Data Transaksi Masuk</a></li>
             </ol>
        </section>
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Transaksi Masuk</label>
...
<div class="content-wrapper">
        ...
        <h1> Data Kas Masuk </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=masuk&act=view">Data Transaski Masuk</a></li>
            <li class="active">Update Data Transaksi Masuk</li>
             </ol>
        </section>
