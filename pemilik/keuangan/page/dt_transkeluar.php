                ...
                <form role="form" method = "POST" action="">
                  ...
                  <?php $kd_transkeluar= kd_transkeluar_auto(); //untuk kode otomatis dng fungsi?>  
                    <div class="form-group">
                      <label for="exampleInputEmail1">Kode Transaksi keluar</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Jenis Transaksi keluar</label>
...
<div class="content-wrapper">
        ...
        <h1> Data transaksi keluar </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=transkeluar&act=view">Data transaksi keluar</a></li>
