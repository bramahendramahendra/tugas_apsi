...
<div class="content-wrapper">
        ...
        <h1> Laporan Rekapitulasi Pengeluaran dan Pemasukan </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
              <li><a href="?pg=laprekap&act=view"><i class="fa fa-dashboard"></i> Laporan Rekapitulasi Pengeluaran dan Pemasukan </a></li>
             </ol>
        </section>
  ...
  if (!(empty($data))){
    ...
    <div class="content-wrapper">
        ...
        <h1> Laporan transaksi keluar</h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Beranda</a></li>
              <li><a href="?pg=laprekap&act=view"><i class="fa fa-dashboard"></i> Laporan transaksi keluar</a></li>
             </ol>
        </section>
    ...
    <section class="content">
      ...
      <form action="?pg=laprekap&act=cek" method="POST">
       <div class="col-md-3">
          <div class="form-group">
          <label for="exampleInputEmail1">Tanggal transaksi keluar Awal</label>
          <input class="form-control" id="date" name="tgltransaw" placeholder="MM/DD/YYY" type="text"/>
          </div>
      </div>
      <div class="col-md-3">
          <div class="form-group">
          <label for="exampleInputEmail1">Tanggal transaksi keluar Akhir</label>
          <input class="form-control" id="date" name="tgltransak" placeholder="MM/DD/YYY" type="text"/>
          </div>
      </div>
      ...
      <div class="row">
              ...
              <div class="box-body">
                  ...
                  <i class="fa fa-file-pdf-o">   Cetak Laporan transaksi keluar </i>  
                  </button>
                  </div>
                  <div class="form-group">
  ...
  <div class="content-wrapper">
      ...
      <h1> Silahkan pilih</h1>
            <ol class="breadcrumb">
              ...
              <li><a href="?pg=laprekap&act=view"><i class="fa fa-dashboard"></i> laporan transaksi Pemasukan dan Pengeluaran </a></li>
             </ol>
      </section>
