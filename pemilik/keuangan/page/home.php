    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg">Laporan Keuangan</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="?pg=masuk&act=view"><i class="fa fa-check-square-o"></i> data pemasukan</a></li>
                <li><a href="?pg=keluar&act=view"><i class="fa fa-check-square-o"></i> data pengeluaran</a></li>
                <li class="treeview">
              <a href="#">
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>PENCATATAN PENGELOLAAN KAS</b>
        </div>
        <strong>Copyright &copy; 2019 <a href="#">Estheetical IT Company</a>.</strong>
      </footer>
