...
<div class="content-wrapper">
        ...
        <h1> Laporan transaksi masuk</h1>
            <ol class="breadcrumb">
              ...
              <li><a href="?pg=lapmasuk&act=view"><i class="fa fa-dashboard"></i> Laporan transaksi masuk</a></li>
             </ol>
        </section>
...
<section class="content">
  ...
  <div class="col-md-3">
      ...
      <label for="exampleInputEmail1">Tanggal transaksi masuk Awal</label>
      <input class="form-control" id="date" name="tgltransmasukaw" placeholder="MM/DD/YYY" type="text"/>
      </div>
  </div>
  <div class="col-md-3">
      <div class="form-group">
      <label for="exampleInputEmail1">Tanggal transaksi masuk Akhir</label>
    ...
    <section class="content">
      ...
      <form role="form" action="cetak_kasmasuk.php" method="POST" target="_blank">
              <div class="box-body">
                  ...
                  <i class="fa fa-file-pdf-o">   Cetak Laporan transaksi masuk </i>  
                  </button>
                  </div>
                  <div class="form-group">
