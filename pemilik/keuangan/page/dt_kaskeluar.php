...
<div class="content-wrapper">
        ...
        <h1> Data Transaksi keluar </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=pggna&act=view">Data Transaksi keluar</a></li>
             </ol>
        </section>
...
<div class="content-wrapper">
        ...
        <h1> Data Kas keluar </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=keluar&act=view">Data Transaksi keluar</a></li>
            <li class="active"><a href="#">Tambah Data Transaksi keluar</a></li>
             </ol>
        </section>
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Transaksi keluar</label>
...
<div class="content-wrapper">
        ...
        <h1> Data Transaksi keluar </h1>
            ...
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=keluar&act=view">Data Transaksi keluar</a></li>
            <li class="active">Update Data Transaksi keluar</li>
             </ol>
        </section>
