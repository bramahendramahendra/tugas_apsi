...
<div class="content-wrapper">
        ...
        <h1> Data transaksi masuk </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=transmasuk&act=view">Data transaksi masuk</a></li>
                ...
                <form role="form" method = "POST" action="">
                  ...
                  <?php $kd_transmasuk= kd_transmasuk_auto(); //untuk kode otomatis dng fungsi?>  
                    <div class="form-group">
                      <label for="exampleInputEmail1">Kode Transaksi Masuk</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Jenis Transaksi Masuk</label>
