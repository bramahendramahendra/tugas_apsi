...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR |Sunday D201</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> D201 Absent: &nbsp </a>
				...
				<a href="absent_ds.php" style="margin-right:20px;">Saturday</a>
				<a href="absent_dsa.php" style="margin-right:20px;color:red;">Sunday</a>
