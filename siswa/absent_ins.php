...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR | Records</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				...
				<li class = "dropdown active">
					...
					<ul class = "dropdown-menu">
						<li><a href = "absent_ins.php"><span class = "glyphicon glyphicon-user"></span>Absent</a></li>
					</ul>
			</ul>
			<br />
			<div class = "alert alert-info">Absent Records</div>
		...
		<div class = "well col-lg-12">
			<br />
			<h2><a style="text-decoration:none;" href = "absent_cf.php"><span class = "glyphicon glyphicon-user"></span> Absent From C101</a></h2>
			<br />
			<br />	
			<h2><a style="text-decoration:none;" href = "absent_df.php"><span class = "glyphicon glyphicon-user"></span> Absent From D201</a></h2>
			<br />
			</div>
		</div>
		<br>	<br>	<br>	<br>
