...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "alert alert-info">
				<a href="#" style="margin-right:20px;" >Friday</a>
				<a href="#" style="margin-right:20px;">Saturday</a>
				<a href="#" style="margin-right:20px;">Sunday</a>
			<a href="absent_c101.php" style="float:right;">Go To C101 Absent Page?</a></div>
