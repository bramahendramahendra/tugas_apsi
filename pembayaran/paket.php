...
<body>
    ...
    <div class="content">
        ...
        <div class="form-header">
            <h3 style="margin-top: 10px; margin-bottom: 10px;"> Paket Bimbel Online</h3>
        </div>
        <form  class="form-content" method="post" action="paket.php">
		    <label>NAMA</label>
                <select name='student'>
            ...
            <label>PAKET</label>
                <select name='tipe'>
                    <option value='' selected>-- Pilih PAKET --</option>
                        <option value="500000">Basic</option>
                        <option value="700000">Premium</option>
                        <option value="1000000">Platinum</option>
                </select>
            <button class="btn btn-primary" type="submit" name="paket">BELI</button>
        </form>
    </div>
</body>
</html>