...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR|Sunday Schedule</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="calendar.php">Friday</a>
			<a href="cal_s.php">Saturday</a>
			<a href="cal_su.php"style="color:red;">Sunday</a>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_admin = $conn->query("SELECT * FROM `calen_sunday`") or die(mysqli_error());
					...
					?>	
						<tr>
							...
							name = "<?php echo $f_admin['cal_id']?>" href = "#" data-toggle = "modal" data-target = "#delete">
		...
		$(document).ready(function(){
			$('.radmin_id').click(function(){
				...
				$('.remove_id').click(function(){
					window.location = 'delete_cal_su.php?cal_id=' + $admin_id;
				});
			});
