...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR|Saturday C101</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> C101 Absent: &nbsp </a>
				<a href="absent_cf.php" style="margin-right:20px;;" >Friday</a>
				<a href="absent_cs.php" style="margin-right:20px;color:red">Saturday</a>
