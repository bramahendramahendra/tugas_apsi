...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR|Sunday C101</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> C101 Absent: &nbsp </a>
				...
				<a href="absent_csa.php" style="margin-right:20px;color:red">Sunday</a>
	...
	<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$q_student = $conn->query("SELECT * FROM `calen_sunday`") or die(mysqli_error());
							...
							if($f_time1['course']=="C101"){
									if($f_time1['schedule']=='Sunday AM' || $f_time1['schedule']=='Sunday PM' ){
