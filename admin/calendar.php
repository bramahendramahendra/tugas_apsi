...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR|Friday Schedule</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="calendar.php" style="color:red;">Friday</a>
			<a href="cal_s.php">Saturday</a>
			<a href="cal_su.php">Sunday</a>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_admin = $conn->query("SELECT * FROM `calen`") or die(mysqli_error());
		...
		$(document).ready(function(){
			$('.radmin_id').click(function(){
				...
				$('.remove_id').click(function(){
					window.location = 'delete_cal.php?cal_id=' + $admin_id;
				});
			});
