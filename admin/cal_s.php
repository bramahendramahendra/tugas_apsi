...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR|Saturday Schedule</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="cal_s.php"style="color:red;">Saturday</a>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_admin = $conn->query("SELECT * FROM `calen_saturday`") or die(mysqli_error());
