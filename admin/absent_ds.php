...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR |Saturday D201</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<a href="#"> D201 Absent: &nbsp </a>
				<a href="absent_df.php" style="margin-right:20px;" >Friday</a>
				<a href="absent_ds.php" style="margin-right:20px;color:red;">Saturday</a>
				<a href="absent_dsa.php" style="margin-right:20px;">Sunday</a>
			<a href="absent_cf.php" style="float:right;">Go To C101 Absent Page?</a></div>
	...
	<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$q_student = $conn->query("SELECT * FROM `calen_saturday`") or die(mysqli_error());
							...
							while($f_time1=$list1->fetch_array())
									{
							if($f_time1['course']=="D201"){
									if($f_time1['schedule']=='Saturday AM' || $f_time1['schedule']=='Saturday PM' ){
