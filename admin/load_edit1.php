	...
	<div class  = "modal-body">
		...
		<div class = "form-group">
								<label>Keterangan</label><br>
									...
									<option style=" padding: .35em .625em .75em; margin: 0 2px; border: 1px solid #c0c0c0;" value="<?php echo $f_edit_student['status'] ?>" required = "required" class = "form-control"><?php echo $f_edit_student['status']?></option>
