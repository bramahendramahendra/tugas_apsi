...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR |Friday C101</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "alert alert-info">
				<a href="#"> C101 Absent: &nbsp </a>
				<a href="absent_cf.php" style="margin-right:20px;color:red;" >Friday</a>
				<a href="absent_cs.php" style="margin-right:20px;">Saturday</a>
				<a href="absent_csa.php" style="margin-right:20px;">Sunday</a>
			<a href="absent_df.php" style="float:right;">Go To D201 Absent Page?</a></div>
	...
	<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$q_student = $conn->query("SELECT * FROM `calen`") or die(mysqli_error());
							while($f_student = $q_student->fetch_array()){
								...
								{
									if($f_time1['course']=="C101"){
											if($f_time1['schedule']=='Friday AM' || $f_time1['schedule']=='Friday PM' ){
												if($f_time1['status']=='Hadir'){			
															echo"<tr><td>".$f_time1['student_no']."</td>";		
															echo"<td>".$f_time1['firstname']." ".$f_time1['middlename']." ".$f_time1['lastname']."</td>";		
															echo"<td>".$f_time1['course']." ".$f_time1['schedule']."</td>";		
															echo"<td style='background-color: GREEN;' >".$f_time1['status']."</td>";		
															echo"<td>".$date."</td>";
												}else{
													echo"<tr><td>".$f_time1['student_no']."</td>";		
													echo"<td>".$f_time1['firstname']." ".$f_time1['middlename']." ".$f_time1['lastname']."</td>";		
													echo"<td>".$f_time1['course']." ".$f_time1['schedule']."</td>";		
													echo"<td style='background-color: RED;' >".$f_time1['status']."</td>";		
													echo"<td>".$date."</td>";
												}
