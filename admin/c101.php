...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR | C101 Records</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<br />
			<div class = "alert alert-info">C101 Student Record</div>
	...
	<div class = "well col-lg-12">
				<table id = "table" class = "table table-bordered">
					...
					<?php
					$Course="C101";
						$q_time = $conn->query("SELECT * FROM `late` Where `student_details` LIKE '%".$Course."%'") or die(mysqli_error());
					...
					?>	
						<tr>
							...
							href = "c101.php?idx=<?php echo $f_time['late_id']?>">
