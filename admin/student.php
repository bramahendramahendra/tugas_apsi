...
<html lang = "eng">
	<head>
		<title>ABSENSI BIMBINGAN BELAJAR| Student Record</title>
		<meta charset = "utf-8" />
	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<br />
			<div class = "alert alert-info">Accounts / Students / <a href="admin.php"style="float:right;">Go To Admin's Page</a></div>
